...
const LogoStrip: React.FC = () => {
  ...
  return (
    <div className="w-full overflow-hidden bg-transparent py-4 group">
      <div className="flex whitespace-nowrap animate-scroll-rtl group-hover:[animation-play-state:paused]">
        {[...logos, ...logos, ...logos].map((logo, index) => (
          <div
            key={index}
            className="inline-flex w-32 h-16 mx-8 items-center justify-center"
          >
            <img
              src={logo.src}
              alt={logo.alt}
